...
public class AvailabilityResponse {
    ...
    @Schema(description = "Whether the room type is available for the full date range", example = "true")
    private boolean available;

    @Schema(description = "Total price for the full stay", example = "15750.00")
    private BigDecimal totalPrice;

    @Schema(description = "Dates in the requested range", example = "[2026-04-01, 2026-04-02, 2026-04-03]")
    private List<LocalDate> dates;

    @Schema(description = "Nightly prices matching the dates list", example = "[3500.00, 5250.00, 7000.00]")
